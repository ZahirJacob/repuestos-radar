...
LOGIN_THROTTLED = "Demasiados intentos. Esperá un momento antes de volver a probar."
LOGOUT_BUTTON = "Salir"
NO_PASSWORD_CONFIGURED = "Falta configurar la contraseña de la app. Avisale al equipo."
LOGIN_STATUS = "Desde Rosario · {count} tiendas en el radar"
LOGIN_STATUS_ONE = "Desde Rosario · 1 tienda en el radar"
LOGIN_STATUS_NO_COUNT = "Desde Rosario"
...
# Home
BEST_CAPTION = "Mejor precio en {store} ({tier})"
...
TIER_STORE_COUNT = "{count} tiendas"
TIER_STORE_COUNT_ONE = "1 tienda"
